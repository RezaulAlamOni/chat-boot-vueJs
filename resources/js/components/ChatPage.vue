                ...
                <div class="card">
                    <div class="card-header msg_head messageSection">
                        <div class="d-flex bd-highlight">
                            ...
                            <div class="user_info">
                                <span>Chat with <b class="text-info">{{chatUser.name}}</b></span>
                                <p>{{chatMessage.length}} Messages</p>
                            </div>
                            <div class="video_cam">
                    ...
                    <div class="card-body msg_card_body messageSection" id="chatDiv">
                        <div v-for="(message , index) in chatMessage">
                            <div v-if="message.sender === chatUser.id">
